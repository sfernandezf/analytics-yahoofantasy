...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('teams', '0007_delete_yahooteamleagueforecast'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yahoo_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forecast_team', to='teams.YahooTeam', verbose_name='Yahoo Team')),
            ],
            options={
                'abstract': False,
            },
